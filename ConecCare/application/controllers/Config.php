...
class Config extends Secure_Controller
{
	...
	private function _licenses()
	{
		...
		$license[$i]['title'] = 'Conec Care IMS' . $this->config->item('application_version');
		...
		{
			$license[$i]['text'] = 'LICENSE file must be in ConecCareIMS license directory. You are not allowed to use ConecCareIMS application until the distribution copy of LICENSE file is present.';
		}
